...
# replace vegan recipe with chicken as protein
...
# replace meat recipe with vegan option
...
determine whether recipe is vegan or type of meat
...
def look_for_meat(ingredients, name):
    ...
    vegans_lst = ['tofu', 'tofurkey', 'impossible burger', 'veggie burger']
    ...
    for n, ingredient in enumerate(ingredients):
        ...
        ingredient = ingredient.replace(",", "")
        if any(x in ingredient.lower() for x in vegans_lst):
